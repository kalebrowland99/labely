                        ...
                        if showingFullDetails {
                            VStack(spacing: 16) {
                                HStack(spacing: 20) {
                                    ...
                                    NutrientItem(icon: "🍬", label: "Sugar", value: "\(food.sugar)g", color: Color(red: 0.18, green: 0.20, blue: 0.24).opacity(0.18))
                                ...
                                VStack(spacing: 12) {
                                    HStack {
                                        Image(systemName: "heart.fill")
                                            .foregroundColor(Color(red: 0.18, green: 0.20, blue: 0.24))
                                        Text("Health Score")
                                            .font(.system(size: 15, weight: .medium))
                                            .foregroundColor(.white.opacity(0.8))
                                ...
                                HStack(spacing: 20) {
                                    ...
                                    if let sugar = nutriments.sugars_100g {
                                        NutrientItem(
                                            ...
                                            color: Color(red: 0.18, green: 0.20, blue: 0.24).opacity(0.18)
                                        )
                                    }
